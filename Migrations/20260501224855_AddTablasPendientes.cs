...
{
    /// <inheritdoc />
    public partial class AddTablasPendientes : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClientesDeudores", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    NumFactura = table.Column<string>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Notificaciones_ClientesDeudores_ClienteId",
                        column: x => x.ClienteId,
                        principalTable: "ClientesDeudores",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
